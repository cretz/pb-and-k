...
data class FieldOptions(
    ...
    val kotlinWrapperType: String? = null,
...
private fun FieldOptions.protoMergeImpl(plus: FieldOptions?): FieldOptions = plus?.copy(
    ...
    kotlinWrapperType = plus.kotlinWrapperType ?: kotlinWrapperType,
...
private fun FieldOptions.protoSizeImpl(): Int {
    ...
    if (kotlinWrapperType != null) protoSize += pbandk.Sizer.tagSize(51236) + pbandk.Sizer.stringSize(kotlinWrapperType)
...
private fun FieldOptions.protoMarshalImpl(protoMarshal: pbandk.Marshaller) {
    ...
    if (kotlinWrapperType != null) protoMarshal.writeTag(409890).writeString(kotlinWrapperType)
...
private fun FieldOptions.Companion.protoUnmarshalImpl(protoUnmarshal: pbandk.Unmarshaller): FieldOptions {
    ...
    var kotlinWrapperType: String? = null
    ...
    while (true) when (protoUnmarshal.readTag()) {
        0 -> return FieldOptions(ctype, packed, jstype, lazy,
            ...
            kotlinWrapperType, kotlinDate, protoUnmarshal.unknownFields())
        ...
        409890 -> kotlinWrapperType = protoUnmarshal.readString()
